...
func (w Walking) Calories() float64 {
	ms := math.Pow(w.meanSpeed()*KmHInMsec, 2.0)
	return (CaloriesWeightMultiplier*w.Weight + (ms/w.Height*CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
