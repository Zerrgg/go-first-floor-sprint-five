...
func (w Walking) Calories() float64 {
	ms := math.Pow(w.meanSpeed()*1000/3600, 2.0)
	return (CaloriesWeightMultiplier*w.Weight + (ms/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
